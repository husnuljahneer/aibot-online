<template>
  <div id="home_top">
    ...
    >
      ...
      <router-link to="/activities" class="w-1/3 btn btn-success h-96 border-0 bg-red-400 m-1"><h1 class="text-xl font-light"> Activities </h1></router-link>
      <div class="w-1/3 btn btn-success h-96 border-0 bg-red-400 m-1"><h1 class="text-xl font-light"> Fun </h1> </div>
      <div class="w-1/3 btn btn-success h-96 border-0 bg-red-400 m-1"><h1 class="text-xl font-light"> Tools </h1> </div>
      </div>
    </div>
  </div>
</template>
...
export default {
  ...
  " Would you rather spend the night in an aquarium or in a botanical garden?",
